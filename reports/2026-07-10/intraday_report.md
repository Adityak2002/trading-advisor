...
- **Opening Range Period:** First 15 minutes of the session (9:15–9:30 IST)
- **Buy Signal:** Price breaks above the OR High with ≥1.5× average volume
- **Target:** +0.8% per trade | **Stop Loss:** -0.4% | **R:R = 2:1**
- **Hard Square-Off:** 15:10 IST — NO overnight positions
...
> **No confirmed ORB breakouts at this time.** Monitoring the watchlist for developing setups.

---

## 👁️ Stocks Building Setup (Inside ORB Range)
...
- 🕒 **Hard Square-Off at 15:10 IST** — Close ALL positions regardless of P&L.
- 🛑 Max **2 concurrent positions** — Do not over-trade.
- 📉 Risk max **₹100 per trade** (2% of corpus).
- 🚫 **Never average down** on an intraday position — exit if stop is hit.
- ⚡ Trailing stop activates at +0.5% — trail 0.3% below running high.
